...
open class RKMixer: RKNode, RKToggleable, RKInput {
	...
	public convenience init(_ inputs: RKNode?...) {
	...
	///
	@objc public convenience init(_ inputs: [RKNode]) {
		self.init()
		for input in inputs {
	...
	open func connect(_ input: RKNode?, bus: Int? = nil) {
	...
	@objc open func connect(input: RKNode?, bus: Int) {
	...
	@objc open func connect(input: RKNode?) {
