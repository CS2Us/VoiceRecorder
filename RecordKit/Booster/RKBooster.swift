...
/// Stereo Booster
///
open class RKBooster: RKNode, RKToggleable, RKComponent, RKInput {
	public typealias RKAudioUnitType = RKBoosterAudioUnit
	...
	@objc open dynamic var rampType: RKSettings.RampType = .linear {
		willSet {
	...
	@objc open dynamic var gain: Double = 1 {
		willSet {
			...
			// if they are we're using this class directly inline as an RKNode
