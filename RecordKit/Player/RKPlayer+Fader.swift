...
extension RKPlayer {
    ...
    internal func initFader(at audioTime: AVAudioTime?, hostTime: UInt64?) {
        ...
        // RKLog(fade, faderNode?.rampDuration, faderNode?.gain, audioTime, hostTime)
        ...
        triggerTime /= _rate
        // RKLog("starting fade in", triggerTime, "seconds")
    ...
    internal func resetFader(_ state: Bool) {
        ...
        faderNode.rampDuration = RKSettings.rampDuration
    ...
    @objc private func startFade() {
        ...
        // RKLog("Fading in to", fade.maximumGain, ", shape:", fade.inRampType.rawValue)
    ...
    @objc internal func fadeOutWithTime(_ time: Double) {
        ...
        if time > 0 {
            ...
            faderNode.gain = Fade.minimumGain
            // RKLog("Fading out to", Fade.minimumGain, ", shape:", fade.outRampType.rawValue)
        }
    }
}
