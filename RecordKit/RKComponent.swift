...
/// Helpful in reducing repetitive code in AudioKit
public protocol RKComponent: AUComponent {
	associatedtype RKAudioUnitType: AnyObject
}

extension RKComponent {
	/// Register the audio unit subclass
	public static func register() {
		AUAudioUnit.registerSubclass(Self.RKAudioUnitType.self,
